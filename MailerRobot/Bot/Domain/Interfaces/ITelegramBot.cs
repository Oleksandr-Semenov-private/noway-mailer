...
public interface ITelegramBot
{
	...
	Task BackButton(long chatId, ParseMode parseMode = ParseMode.Markdown, InlineKeyboardMarkup? replyMarkup = default, CancellationToken cancellationToken = default);
}