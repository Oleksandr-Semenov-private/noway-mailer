...
[MessageHandler(HandlerName.SubscriptionFor7Days)]
internal class BuySubscriptionFor7Days : MessageHandler
{
	private readonly ITelegramBot _botClient;
	private MessageData _message = null!;

	public BuySubscriptionFor7Days(ITelegramBot botClient)
	{
