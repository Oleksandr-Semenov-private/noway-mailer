...
[MessageHandler(HandlerName.SubscriptionFor3Days)]
internal class BuySubscriptionFor3Days : MessageHandler
{
	private readonly ITelegramBot _botClient;
	private MessageData _message = null!;

	public BuySubscriptionFor3Days(ITelegramBot botClient)
	{
