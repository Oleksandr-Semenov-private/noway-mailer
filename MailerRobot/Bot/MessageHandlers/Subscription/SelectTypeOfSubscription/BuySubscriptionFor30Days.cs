...
[MessageHandler(HandlerName.SubscriptionFor30Days)]
internal class BuySubscriptionFor30Days : MessageHandler
{
	private readonly ITelegramBot _botClient;
	private MessageData _message = null!;

	public BuySubscriptionFor30Days(ITelegramBot botClient)
	{
